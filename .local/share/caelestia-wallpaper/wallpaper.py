...
UID = os.getuid()
SOCKET_PATH = f"/tmp/caelestia-wallpaper-{UID}.sock"
LOCK_SOCKET_PATH = f"/tmp/caelestia-lock-{UID}.sock"
...
DATA_DIR = os.path.expanduser("~/.local/share/caelestia-wallpaper")
