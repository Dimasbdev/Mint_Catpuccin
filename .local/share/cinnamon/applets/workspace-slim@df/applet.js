...
function WorkspaceSlimApplet(metadata, orientation, panel_height, instance_id) {
    this._init(metadata, orientation, panel_height, instance_id);
}

WorkspaceSlimApplet.prototype = {
    ...
    _init: function(metadata, orientation, panel_height, instance_id) {
        ...
        this.capsule = new St.BoxLayout({
            style_class: "workspace-slim-capsule",
    ...
    _rebuild: function() {
        ...
        for (let i = 0; i < num_ws; i++) {
            ...
            let lbl = new St.Label({
                text: (i + 1).toString(),
                style: "font-family: Inter, sans-serif; font-size: 8px; font-weight: bold;"
            });
    ...
    _update: function() {
        ...
        for (let i = 0; i < this.items.length; i++) {
            ...
            if (i === active_idx) {
                // Petite 14x14 circular badge for active workspace
                item.bin.style = "background-color: #f5c2e7; border-radius: 9999px; width: 14px; height: 14px; margin: 0 1px;";
                item.lbl.style = "color: #11111b; font-size: 8px; font-weight: 900;";
            } else {
                // Inactive workspace
                item.bin.style = "background-color: transparent; border-radius: 9999px; width: 10px; height: 14px; margin: 0 1px;";
                item.lbl.style = "color: #a6adc8; font-size: 8px; font-weight: 600;";
            }
        }
    },
...
function main(metadata, orientation, panel_height, instance_id) {
    return new WorkspaceSlimApplet(metadata, orientation, panel_height, instance_id);
}
