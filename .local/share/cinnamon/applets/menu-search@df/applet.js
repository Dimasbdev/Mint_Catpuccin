...
class SimpleMenuItem {
    ...
    addIcon(iconSize, iconName='', gicon=null, symbolic=false) {
        ...
        let params = { icon_size: iconSize || 22 };
...
class CinnamonMenuApplet extends Applet.TextIconApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "menu-search@df", instance_id);
    ...
    _setStyle() {
        ...
        this._applet_icon.set_icon_size(14);
    }
    ...
    _updateIconAndLabel(){
        try {
            this.set_applet_icon_symbolic_name("system-search-symbolic");
        } catch(e) {
            global.logWarning("Could not set search icon: " + e);
        }
        if (this._applet_label) {
            this._applet_label.hide();
            this._applet_label.destroy();
            this._applet_label = null;
        }
        if (this._applet_icon_box) {
            this._applet_icon_box.x_align = Clutter.ActorAlign.CENTER;
            this._applet_icon_box.y_align = Clutter.ActorAlign.CENTER;
            this._applet_icon_box.show();
        this._applet_icon_box.x_expand = true;
        this._applet_icon_box.x_align = Clutter.ActorAlign.CENTER;
        this._applet_icon_box.y_align = Clutter.ActorAlign.CENTER;
        }
        if (this._applet_icon) {
            this._applet_icon.x_align = Clutter.ActorAlign.CENTER;
            this._applet_icon.y_align = Clutter.ActorAlign.CENTER;
            this._applet_icon.set_icon_size(14);
        }
