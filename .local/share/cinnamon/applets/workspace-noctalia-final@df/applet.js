...
function WorkspaceNoctaliaFinalApplet(metadata, orientation, panel_height, instance_id) {
    this._init(metadata, orientation, panel_height, instance_id);
}

WorkspaceNoctaliaFinalApplet.prototype = {
...
function main(metadata, orientation, panel_height, instance_id) {
    return new WorkspaceNoctaliaFinalApplet(metadata, orientation, panel_height, instance_id);
}
