...
SOCKET_PATH = f"/tmp/caelestia-clip-{os.getuid()}.sock"
DATA_DIR = os.path.expanduser("~/.local/share/caelestia-clip")
...
class CaelestiaClipWindow(Gtk.Window):
    def __init__(self):
        super().__init__(type=Gtk.WindowType.TOPLEVEL)
        self.set_title("CaelestiaClipboard")
