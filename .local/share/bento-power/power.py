...
SOCKET_PATH = f"/tmp/bento-power-{os.getuid()}.sock"
DATA_DIR = os.path.expanduser("~/.local/share/bento-power")
...
class BentoPowerWindow(Gtk.Window):
    def __init__(self):
        super().__init__(type=Gtk.WindowType.TOPLEVEL)
        self.set_title("BentoPowerMenu")
