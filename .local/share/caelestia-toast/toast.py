...
class ToastWindow(Gtk.Window):
    def __init__(self):
        ...
        html_path = os.path.expanduser("~/.local/share/caelestia-toast/index.html")
...
class NotificationServer(dbus.service.Object):
        ...
        for key in ('image-data', 'image_data', 'icon_data'):
            if key in hints:
                try:
                    ...
                    dest = f"/tmp/caelestia-toast-{nid}.png"
    ...
    def GetServerInformation(self):
        return ('Caelestia Toast', 'Caelestia', '1.0', '1.2')
