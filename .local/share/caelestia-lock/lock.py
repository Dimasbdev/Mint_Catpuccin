...
SOCKET_PATH = f"/tmp/caelestia-lock-{os.getuid()}.sock"
...
class CaelestiaLockWindow(Gtk.Window):
    def __init__(self):
        ...
        html_path = os.path.expanduser("~/.local/share/caelestia-lock/index.html")
        ...
        self._art_cache_path = f"/tmp/caelestia-album-art-{os.getuid()}.jpg"
